...
reviewing remaining phases against the _actual_ state of completed work,
...
schema quote, etc.). The devil's advocate is _especially_ prone to
...
- **Verify findings before baking fixes.** Reviewer and DA findings are
  ...
  findings are _especially_ prone to confidently-false empirical claims
